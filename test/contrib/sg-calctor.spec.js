...
describe('SgCalctor', () => {
    ...
    it('should calc monthly the tax year of 2012 to 2016', () => {
        let taxYear = '2013_2014';
        const sgCalctor = new SgCalctor();

        let taxInfo = sgCalctor.calc(3000, {
            taxYear: taxYear,
            period: 'monthly'
        });
    ...
    it('should throw not supported tax year yearly', () => {
        const sgCalctor = new SgCalctor();
        assert.throws(() => {
            sgCalctor.calc(1000, {
                taxYear: '2010',
    ...
    it('should throw not supported tax year monthly', () => {
        const sgCalctor = new SgCalctor();
        assert.throws(() => {
            sgCalctor.calc(1000, {
                taxYear: '2011',
